...
<li>Zhou Y,  Zhou J, Ju Y, <b>Fan G</b>, et al. DCD-UIE: Decoupled Chromatic Diffusion Model for Underwater Image Enhancement[J]. Submitted to IEEE Transactions on Image Processing, 2025 (Under Review, SCI Q1 TOP, CCF A, IF: 13.7, <b>Corresponding Author</b>)</li>
 <li> <b>Fan G</b>, Hu S, Zhou J et al. Color and Texture Count Alike: An Underwater Image Enhancement Method via Dual-Attention Fusion[J]. Information Fusion, 2025 (Accept, SCI Q1 TOP, IF: 15.5)</li>
